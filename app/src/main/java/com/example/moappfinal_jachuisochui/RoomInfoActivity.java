...
public class RoomInfoActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button_jjim = (Button)findViewById(R.id.Button_Jjim);
...
//        TextView_Longitude.setText(lon);
        ...
        Button_jjim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //한번더 누르면 이미 찜한 방임니다 토스트박스
                selectandupdate(latitude,longitude, finalUsername);
                updateconfirm(latitude,longitude);
    ...
    void updateconfirm(double latitude,double longitude)

    {
        ...
        while(c.moveToNext())
        {
            ...
            {
                Toast.makeText(getApplicationContext(), "방을 찜했습니다:"+c.getString(1), Toast.LENGTH_LONG).show();
                return;
            }
        }
    }
...
//                Toast.makeText(getApplicationContext(), "탐색성공!", Toast.LENGTH_LONG).show();
    ...
    void selectandupdate(double latitude,double longitude,String finusername)

    {
        ...
        while(c.moveToNext())
        {
            ...
            if ((c.getDouble(4)==latitude)&&(c.getDouble(5)==longitude))
            {
                ...
                db.execSQL("UPDATE "+tableName+" SET jjimusername = '"+finusername+"' WHERE roomid = "+c.getInt(0)+";");
//                Toast.makeText(getApplicationContext(), "방을 찜했습니다:"+c.getString(1)+" 찜한유저"+c.getString(7), Toast.LENGTH_LONG).show();
//                Toast.makeText(getApplicationContext(), "방을 찜했습니다:", Toast.LENGTH_LONG).show();
